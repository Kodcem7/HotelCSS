...
export const PHRASE_TRANSLATIONS = {
    ...
    ru: {
        ...
        'Sorry, I couldn\'t understand that. Try something like "2 полотенца" (2 towels), "разбуди меня в 8 утра" (wake me up at 8 AM).': 'Извините, я не понял. Попробуйте, например: "2 полотенца", "разбуди меня в 8 утра" или "что можно купить за баллы?".',
