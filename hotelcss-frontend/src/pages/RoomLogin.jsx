...
import { useNavigate, Link, useSearchParams } from 'react-router-dom'; // 👈 1. ADDED useSearchParams
...
const RoomLogin = () => {
    ...
    // 👇 3. PRE-FILL STATE FROM URL PARAMS IF THEY EXIST
        ...
        try {
            ...
            if (res.success && res.token) {
                ...
                if (!ok) {
                    ...
                    navigate('/room'); // Adjust this path if needed (e.g., '/room/dashboard')
                }
            } else {
