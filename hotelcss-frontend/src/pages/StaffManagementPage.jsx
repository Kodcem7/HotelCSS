        ...
        <> {/* ✅ Replaced <Layout> with Fragment */}
            <div className="p-4 sm:p-10 space-y-6 sm:space-y-8 max-w-7xl mx-auto">
                ...
                {staff.length === 0 ? (
                    ...
                    <div className="max-w-5xl mx-auto bg-[#FDFBF7] rounded-[22px] sm:rounded-[28px] border border-[#E3DCD2]/30 shadow-[0_20px_40px_rgba(15,28,44,0.04)] overflow-hidden">
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                        <div className="bg-[#FDFBF7] rounded-[28px] border border-[#E3DCD2]/40 shadow-2xl max-w-md w-full p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    <label className="block text-sm font-semibold text-[#4A3728] mb-1">Full Name *</label>
                                    <input
                                        type="text"
                                        value={formData.Name}
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-[#4A3728] mb-1">Username *</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-[#4A3728] mb-1">Email *</label>
                                    <input
                                        type="email"
                                ...
                                <div className="flex space-x-3 pt-4">
                                    <button type="submit" className="flex-1 bg-[#4A3728] text-white py-3 px-4 rounded-2xl hover:bg-[#3a2b20] transition font-semibold">
                                        {editingStaff ? 'Update' : 'Create'}
                                    </button>
                                    <button type="button" onClick={handleCloseModal} className="flex-1 bg-[#F2EBE1] text-[#4A3728] py-3 px-4 rounded-2xl hover:bg-[#E8DFD1] transition font-semibold border border-[#E3DCD2]/40">
                                        Cancel
                                    </button>
                                </div>
                            </form>
