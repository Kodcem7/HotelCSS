...
const RoomReceptionRequestPage = () => {
    ...
    if (loadingPickup && selectedType === 'pickup-info') {
        // Logic for inline loading if needed, but the main loading is handled by the initial fetch
    }

    // Handle main loading state without Layout
    if (submitting) {
        // You could return a spinner here if you want to block the UI
    }
