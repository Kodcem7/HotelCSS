                        ...
                        <div className="flex items-end justify-between">
                            <div>
                                ...
                                <p className="text-[14px] text-[#5D534A] leading-relaxed">
                                    Instant access to core administrative modules.
                                </p>
                            </div>
                                ...
                                >
                                    <div>
                                        <div className="w-12 h-12 rounded-full bg-[#FDFBF7] border border-[#E3DCD2]/30 flex items-center justify-center mb-6">
                                            <span className="material-symbols-outlined text-[#D35400] text-3xl">
                                                {link.icon}
                                            </span>
                                        </div>
                                        <h4 className="font-headline text-xl text-[#4A3728] font-bold mb-2">
                                            {link.title}
                                        </h4>
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/10 shadow-[0_20px_40px_rgba(15,28,44,0.04)] group hover:scale-[1.02] transition-transform duration-300">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="text-xs font-label uppercase tracking-widest text-secondary opacity-60">
                                    <br />
                                </span>
                            </div>
                        ...
                        <div className="bg-primary text-white p-8 rounded-xl shadow-[0_30px_60px_rgba(14,28,43,0.15)] relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300">
                            <div className="relative z-10">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest bg-red-700 text-white px-3 py-1 rounded-full">
                                        Urgent
                                    </span>
                                </div>
