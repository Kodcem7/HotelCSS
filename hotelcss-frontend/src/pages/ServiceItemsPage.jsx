            ...
            <div className="p-4 sm:p-10 space-y-6 sm:space-y-8 max-w-7xl mx-auto">
                ...
                {filteredItems.length === 0 ? (
                    ...
                    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredItems.map((item) => (
                            <div
                                key={item.id}
                                className="bg-[#FDFBF7] rounded-[22px] sm:rounded-[28px] border border-[#E3DCD2]/30 shadow-[0_20px_40px_rgba(15,28,44,0.04)] overflow-hidden flex flex-col"
                            >
                                {item.imageUrl && (
                                    <img
                                ...
                                <div className="p-6 text-center flex flex-col flex-grow">
                                    ...
                                    <div className="flex flex-wrap gap-2 justify-center mb-5 mt-auto">
                                        ...
                                        {item.pointsCost > 0 && (
                                            <span className="px-3 py-1 bg-[#FBEAEA] text-[#B22222] font-bold rounded-xl border border-[#F7D9D9]">
                                                -{item.pointsCost} PTS
                                            </span>
                                        )}
                                    </div>
                ...
                {showModal && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                        <div className="bg-[#FDFBF7] rounded-[28px] border border-[#E3DCD2]/40 shadow-2xl max-w-xl w-full p-6 max-h-[90vh] overflow-y-auto">
