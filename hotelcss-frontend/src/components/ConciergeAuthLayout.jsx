...
const HERO_IMAGE =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuBUUy1965Hk11UAH0iXbZL-Rl26iH0sPdW-hfi2oeLKBx_xFErcpYxuo43Lrx8BU8oPLt2ualgcuxosoYI7IKooElqpD0a-wtAWiCjYPlxJbgWC6uR-lZB8qJLr-UHZ3lqca5NBOQJItmF8CjOTz0YVKXknrl4TVSBZnZ4lWk_9T9biTBCikmA4I1f1CnZEnR3yJMtpJVxfyV1p6QKljN7fHTuA4wJyZyrPtWYRxRAE8o6cJ3v6lqTAkdHCAQcs8AYamj1nb2BWGTUW';
        ...
        <div className="lg:col-span-5 relative hidden lg:block overflow-hidden min-h-[520px]">
          ...
          <div className="absolute inset-0 z-20 p-12 flex flex-col justify-between text-white">
            ...
            <div className="space-y-4 bg-black/10 backdrop-blur-sm p-8 rounded-[3rem] -mx-4">
              <h2 className="font-headline text-4xl leading-tight">{heroHeadline}</h2>
        ...
        <div className="lg:col-span-7 bg-concierge-surface-container-lowest p-8 md:p-16 lg:p-24 flex flex-col justify-center min-h-[min(100vh-3rem,720px)]">
          <div className="max-w-md mx-auto w-full">
            ...
            <header className="mb-12">
              ...
              <h1 className="font-headline text-4xl sm:text-5xl text-concierge-on-background mb-4">{title}</h1>
